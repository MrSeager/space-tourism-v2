...
const PageThree: FC<PageThreeProps> = ({ crewData }) => {
    ...
    return (
        <Container fluid className='cs-bg-page-three min-vh-100 px-5 d-flex flex-column justify-content-between'>
            <Container fluid className='cs-top-h px-5 d-flex flex-row align-items-end justify-content-start'>
            ...
            <Row className='mx-0'>
                <Col lg={6} xs={12} className='ps-5 text-white text-lg-start text-center d-flex flex-column justify-content-end gap-3 pt-lg-0 pt-5'>
                    <Container className='h-100 my-auto px-0 d-flex flex-column justify-content-center align-items-center gap-3'>
                        ...
                        <p className='cs-three-line-p w-100 text-white'>{crewData[member].bio}</p>
                    </Container>
